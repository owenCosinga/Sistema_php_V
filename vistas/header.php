  ...
  <head>
    ...
    <link rel="shortcut icon" href="../public/img/favicon.ico">
     ...
     <!-- DATATABLES -->
         ...
         <link  type="text/css" href="../public/datatables/buttons.dataTables.min.css" rel="stylesheet" />
         <link  type="text/css" href="../public/datatables/responsive.dataTables.min.css" rel="stylesheet" />
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Enrique Cosinga</span>
                </a>
